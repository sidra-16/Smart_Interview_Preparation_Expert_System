...
*   **[SWI-Prolog](https://www.swi-prolog.org/)**: The primary engine for symbolic reasoning and backward chaining.
*   **[PySwip](https://github.com/yuce/pyswip)**: A Python library that allows the application to query the Prolog knowledge base.
*   **[Streamlit](https://docs.streamlit.io/)**: The framework used to build the interactive web dashboard and UI.
